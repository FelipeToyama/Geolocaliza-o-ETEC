...
export class HomePage implements OnInit, OnDestroy {
  ...
  leafletMap(lat, long) {
    ...
    const ondeestou = Leaflet.icon({
      iconUrl:
        'https://i.pinimg.com/originals/e5/93/ab/e593ab0589d5f1b389e4dfbcce2bce20.gif', //https://www.clockon.com.au/hs-fs/hubfs/i%20Map%20Pin.gif?width=300&name=i%20Map%20Pin.gif
      iconSize: [30, 30],
      iconAnchor: [15, 20],
      popupAnchor: [-1.5, -20],
    });
